...
<div class="min-h-screen flex flex-col lg:flex-row bg-white">
    ...
    <div class="hidden lg:flex lg:w-5/12 xl:w-1/3 relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col justify-between h-full p-8 xl:p-12">
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="text-white font-medium text-sm tracking-wide">{{ strtoupper(Setting::get('store_name', 'Bintang Agung Tani')) }}</span>
            </div>
            ...
            <div class="flex-1 flex flex-col justify-center items-center py-8">
                <div class="w-full max-w-[260px] xl:max-w-[300px] mb-6">
                    <img src="/images/logo.png" 
                         alt="{{ Setting::get('store_name', 'Bintang Agung Tani') }}" 
                         class="w-full h-auto"
    ...
    <div class="flex-1 flex flex-col justify-center items-center p-6 sm:p-8 lg:p-12 xl:p-16 bg-gradient-to-b from-gray-50 via-white to-primary-50/30">
        ...
        <div class="lg:hidden mb-8 text-center">
            ...
            <h1 class="text-lg font-bold text-gray-900">{{ Setting::get('store_name', 'Bintang Agung Tani') }}</h1>
            <p class="text-primary-600 text-sm">Lupa Password</p>
        </div>
        
        <!-- Form Container -->
        <div class="w-full max-w-[400px]" x-data="{ sent: {{ session('status') ? 'true' : 'false' }} }">
            ...
            @if (session('status'))
                ...
                @if (session('reset_url'))
                    <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                        ...
                        <a href="{{ session('reset_url') }}" class="text-sm text-blue-600 hover:text-blue-800 underline break-all">
                            {{ session('reset_url') }}
                        </a>
                    </div>
                @endif
            ...
            <p class="text-center text-xs text-gray-400 mt-8">
                © {{ date('Y') }} {{ Setting::get('store_name', 'Bintang Agung Tani') }}
            </p>
        </div>
    </div>
</div>
