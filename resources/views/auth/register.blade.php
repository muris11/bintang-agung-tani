...
<div class="min-h-screen flex flex-col lg:flex-row bg-white">
    ...
    <div class="hidden lg:flex lg:w-5/12 xl:w-1/3 relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col justify-between h-full p-8 xl:p-12">
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="text-white font-medium text-sm tracking-wide">{{ strtoupper(config('app.store_name', 'Bintang Agung Tani')) }}</span>
            </div>
            ...
            <div class="flex-1 flex flex-col justify-center items-center py-8">
                ...
                <h2 class="text-2xl xl:text-3xl font-bold text-white text-center leading-tight">
                    Bergabung<br>
                    <span class="text-primary-200">Gratis</span>
                </h2>
            ...
            <div class="grid grid-cols-2 gap-4 pt-6 border-t border-white/10">
                <div class="text-center">
                    <div class="text-2xl xl:text-3xl font-bold text-white">{{ config('app.total_products', '200+') }}</div>
                    <div class="text-primary-200 text-xs xl:text-sm">Produk</div>
                </div>
                <div class="text-center">
                    <div class="text-2xl xl:text-3xl font-bold text-white">{{ config('app.total_farmers', '10K+') }}</div>
    ...
    <div class="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-12 lg:py-0 bg-gradient-to-b from-gray-50 via-white to-primary-50/30">
        ...
        <div class="lg:hidden mb-8 text-center">
            ...
            <h1 class="text-lg font-bold text-gray-900">{{ config('app.store_name', 'Bintang Agung Tani') }}</h1>
        ...
        <div class="w-full max-w-md space-y-8">
            ...
            <div class="mb-8 text-center lg:text-left">
                <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Buat Akun</h2>
                <p class="text-gray-500">Lengkapi data Anda untuk bergabung</p>
            </div>
            ...
            <form action="/register" method="POST" class="mt-8 space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" 
                               placeholder="Masukkan nama lengkap Anda" required minlength="2"
                ...
                <div x-data="{ show: false }">
                    ...
                    <p class="text-xs text-gray-400 mt-1.5">Minimal 8 karakter untuk keamanan akun Anda</p>
                </div>
                ...
                <label class="flex items-start gap-3 cursor-pointer">
                    <input type="checkbox" name="terms" required class="peer sr-only mt-1">
                    <div class="w-5 h-5 bg-white border-2 border-gray-300 rounded peer-checked:bg-primary-600 peer-checked:border-primary-600 flex items-center justify-center transition-all shadow-sm shrink-0 mt-0.5">
                    ...
                    <span class="text-sm text-gray-600 leading-relaxed">
                        Saya setuju dengan 
                        <a href="/user/syarat-ketentuan" class="text-primary-600 hover:text-primary-700 font-semibold transition-colors">Syarat</a> dan 
                        <a href="/user/kebijakan-privasi" class="text-primary-600 hover:text-primary-700 font-semibold transition-colors">Kebijakan Privasi</a>
                    </span>
                </label>
            ...
            <div class="text-center">
                <p class="text-gray-500 text-sm">
                    Sudah punya akun? 
                    <a href="/login" class="font-semibold text-primary-600 hover:text-primary-700 transition-colors inline-flex items-center min-h-[44px] px-2 -mx-2">
                        Masuk di sini
                    </a>
                </p>
            </div>
