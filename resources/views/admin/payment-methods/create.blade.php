...
<div class="max-w-7xl mx-auto space-y-6 pb-12 relative z-10 w-full px-4 sm:px-0 mt-4 md:mt-0">
    ...
    <div class="card p-0 overflow-hidden border-primary-100">
        ...
        <form action="{{ route('admin.payment-methods.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" id="name" 
                           ...
                           value="{{ old('name') }}" required placeholder="Contoh: Transfer Bank BCA">
                    @error('name')
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="bank_name" id="bank_name" 
                           ...
                           value="{{ old('bank_name') }}" required placeholder="Contoh: BCA">
                    @error('bank_name')
                        <p class="text-red-600 text-sm flex items-center gap-1">
                            <i class="ph ph-warning-circle w-4 h-4"></i>
                            {{ $message }}
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="account_number" id="account_number" 
                           ...
                           value="{{ old('account_number') }}" required placeholder="1234567890">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="account_name" id="account_name" 
                           ...
                           value="{{ old('account_name') }}" required placeholder="PT Bintang Agung">
                    @error('account_name')
                        <p class="text-red-600 text-sm flex items-center gap-1">
                            <i class="ph ph-warning-circle w-4 h-4"></i>
                            {{ $message }}
                ...
                <div class="space-y-2 md:col-span-2">
                    ...
                    <textarea name="instructions" id="instructions" rows="4" 
                              ...
                              placeholder="Masukkan instruksi pembayaran untuk pelanggan...">{{ old('instructions') }}</textarea>
                    @error('instructions')
                        <p class="text-red-600 text-sm flex items-center gap-1">
                            <i class="ph ph-warning-circle w-4 h-4"></i>
                            {{ $message }}
