        ...
        <div class="card p-6 space-y-6">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-input w-full" placeholder="Masukkan nama lengkap" required>
                </div>

                <div>
                    <label for="email" class="form-label mb-1.5 block">Alamat Email <span class="text-red-500">*</span></label>
                    <input type="email" id="email" name="email" value="{{ old('email') }}" class="form-input w-full" placeholder="nama@email.com" required>
                </div>

                <div>
                    <label for="phone" class="form-label mb-1.5 block">No. Telepon <span class="text-gray-400 font-normal ml-1">(Opsional)</span></label>
                    <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" class="form-input w-full" placeholder="08xxxxxxxxxx">
                </div>
