            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
                ...
                <div class="lg:col-span-5">
                    <a href="/user/dashboard" class="flex items-center gap-3 mb-6 group">
                        @if(file_exists(public_path('images/logo.png')))
                            <div class="relative">
                                ...
                                <img loading="lazy" src="/images/logo.png" alt="{{ $storeName }}" class="h-12 w-auto relative z-10">
                            </div>
                        @else
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ Setting::get('social_twitter') }}" target="_blank" rel="noopener noreferrer" 
                           class="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-white hover:text-primary-700 hover:scale-110 transition-all duration-300 shadow-lg">
                            <i class="ph ph-twitter-logo text-lg"></i>
                        </a>
                        @endif
                        @if(Setting::get('social_youtube'))
                        <a href="{{ Setting::get('social_youtube') }}" target="_blank" rel="noopener noreferrer" 
                           class="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-white hover:text-primary-700 hover:scale-110 transition-all duration-300 shadow-lg">
                            <i class="ph ph-youtube-logo text-lg"></i>
                        </a>
                        @endif
                        @if(Setting::get('social_tiktok'))
                        <a href="{{ Setting::get('social_tiktok') }}" target="_blank" rel="noopener noreferrer" 
                           class="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-white hover:text-primary-700 hover:scale-110 transition-all duration-300 shadow-lg">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start gap-3">
                            ...
                            <div class="text-sm">
                                ...
                                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', Setting::get('whatsapp_number', '082212345678')) }}" 
                                   class="text-primary-100 hover:text-white transition-colors">
                                    {{ Setting::get('whatsapp_number', '0822-1234-5678') }}
                                </a>
                            </div>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <div class="text-sm">
                                ...
                                <a href="mailto:{{ Setting::get('contact_email', 'info@bintangtani.com') }}" 
                                   class="text-primary-100 hover:text-white transition-colors">
                                    {{ Setting::get('contact_email', 'info@bintangtani.com') }}
                                </a>
                            </div>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <div class="text-sm">
                                ...
                                <p class="text-primary-100 leading-relaxed">
                                    {{ Setting::get('store_address', 'Jl. Pertanian No. 125, Jakarta Selatan, Indonesia') }}
                                </p>
                            </div>
                        </li>
                        <li class="flex items-start gap-3">
