                ...
                <div class="lg:col-span-8 space-y-8">
                        ...
                        <div class="text-center sm:text-left space-y-2">
                            ...
                            <div class="mt-3 flex items-center justify-center sm:justify-start gap-3">
                                ...
                                @if ($user->profile_photo_path)
                                    <form action="{{ route('user.profil.photo.destroy') }}" method="POST"
                    ...
                    <form action="{{ route('user.profil.update') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="space-y-1.5 md:col-span-2 text-left">
                            ...
                            <input type="text" id="namaLengkap" name="name" value="{{ $user->name }}"
                        ...
                        <div class="space-y-1.5 text-left">
                            ...
                            <input type="tel" id="telepon" name="phone" value="{{ $user->phone ?? '' }}"
                                class="form-input w-full">
                        </div>
                        ...
                        <div class="space-y-1.5 md:col-span-2 text-left">
                            ...
                            <div class="form-input w-full min-h-[88px] bg-gray-50 text-gray-700 leading-relaxed">
                                {{ $user->defaultAddress?->getCompleteAddressAttribute() ?? 'Alamat utama belum diatur. Silakan kelola di menu Alamat.' }}
                            </div>
                    ...
                    <div class="card overflow-hidden shadow-sm">
                        ...
                        <div class="p-5 space-y-4 text-sm">
                            <div class="flex items-start justify-between">
                                ...
                                <span
                                    class="font-bold text-gray-900 bg-gray-100 px-2 py-0.5 rounded">{{ auth()->user()->orders()->where('status', 'completed')->count() }}
                                    Transaksi</span>
                            </div>
                            <div class="flex items-start justify-between">
                                <span class="text-gray-500 font-medium">Total Belanja (Bulan ini)</span>
                                <span
                                    class="font-bold text-gray-900">{{ auth()->user()->getFormattedMonthlySpending() }}</span>
                            </div>
                    ...
                    <div class="card p-5 shadow-sm bg-gradient-to-br from-white to-gray-50/50">
                        ...
                        <div class="space-y-3.5 text-sm text-gray-600">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <span
                                    class="leading-relaxed font-medium text-gray-800">{{ $user->defaultAddress?->getCompleteAddressAttribute() ?? 'Alamat utama belum diisi' }}</span>
                            </div>
                        </div>
                    </div>
