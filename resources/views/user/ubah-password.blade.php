...
<div class="max-w-7xl mx-auto space-y-6 pb-12 px-4 sm:px-0 mt-4 md:mt-0 relative z-10 w-full">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2">
        <div>
            <nav class="flex text-sm text-gray-500 mb-2" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li><div class="flex items-center"><i class="ph ph-caret-right mx-1 text-gray-400 w-3 h-3"></i><a href="{{ route('user.profil.show') }}" class="hover:text-primary-600 transition-colors">Akun Saya</a></div></li>
        ...
        <div class="flex items-center gap-3">
             <a href="{{ route('user.profil.show') }}" class="btn-secondary text-sm h-10 shadow-sm border-gray-200">
        ...
        <div class="lg:col-span-3 space-y-2">
            <div class="card p-3">
                <nav class="flex flex-col space-y-1">
                    <a href="{{ route('user.profil.show') }}" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-600 rounded-xl hover:bg-gray-50 hover:text-gray-900 transition-colors">
                    ...
                    <a href="{{ route('user.orders.index') }}" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-600 rounded-xl hover:bg-gray-50 hover:text-gray-900 transition-colors">
        ...
        <div class="lg:col-span-9 space-y-6">
            <div class="card p-0 overflow-hidden">
                ...
                <div class="p-6 md:p-8">
                    <form action="{{ route('user.profil.password') }}" method="POST" class="max-w-xl space-y-6" x-data="{ showPass1: false, showPass2: false, showPass3: false }">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex items-center gap-3 pt-6 border-t border-gray-100">
                            ...
                            <a href="{{ route('user.profil.show') }}" class="btn-secondary h-12 px-6 text-sm border-gray-200 inline-flex items-center justify-center">
                                Batal
                            </a>
                        </div>
                    </form>
