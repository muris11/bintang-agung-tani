...
<?php $__env->startSection('content'); ?>
    <div class="p-4 md:p-6 max-w-5xl mx-auto">
        ...
        <div class="flex flex-wrap items-center gap-3 mb-6">
            <form action="<?php echo e(route('admin.messages.mark-all-read')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <button type="submit"
            ...
            <a href="<?php echo e(route('admin.messages.unread')); ?>"
            ...
            <?php if($messages->count() > 0): ?>
                <div class="divide-y divide-gray-100">
                    <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-4 md:p-5 hover:bg-gray-50 transition-colors <?php echo e(!$message->is_read ? 'bg-blue-50/30' : ''); ?>">
                            <div class="flex items-start gap-4">
                                <div class="flex-shrink-0">
                                    <div class="w-10 h-10 rounded-xl <?php echo e($message->is_read ? 'bg-gray-100 text-gray-600' : 'bg-amber-100 text-amber-600'); ?> flex items-center justify-center">
                                        <i class="ph ph-envelope<?php echo e($message->is_read ? '' : '-simple'); ?> w-5 h-5"></i>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <?php if(!$message->is_read): ?>
                                        <form action="<?php echo e(route('admin.messages.mark-read', $message->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <?php endif; ?>
                                    <form action="<?php echo e(route('admin.messages.destroy', $message->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bintang-agung-tani\resources\views\admin\messages\index.blade.php ENDPATH**/ ?>