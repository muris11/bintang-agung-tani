                ...
                <div class="divide-y divide-gray-100">
                    ...
                    <div class="p-6 flex flex-col sm:flex-row items-start gap-5 hover:bg-gray-50/30 transition-colors">
                        <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-xl bg-gray-100 border border-gray-200 shrink-0 overflow-hidden shadow-sm">
                            <img loading="lazy" src="<?php echo e($item->product ? ($item->product->getFirstImage() ?? asset('images/placeholder-product.png')) : asset('images/placeholder-product.png')); ?>" alt="<?php echo e($item->product_name); ?>" class="w-full h-full object-cover">
                        </div>
                        <div class="flex-grow flex flex-col justify-between w-full">
                            <div class="flex flex-col sm:flex-row justify-between sm:items-start gap-2">
                                <div>
                                    ...
                                    <p class="text-gray-500 text-xs sm:text-sm font-medium"><?php echo e($item->product ? ($item->product->category->name ?? '-') : '-'); ?></p>
                                </div>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-100">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="inline-flex py-1 px-2.5 text-[10px] font-bold uppercase tracking-wider rounded
                                <?php if($latestProof->status === 'pending'): ?> bg-yellow-100 text-yellow-700 border border-yellow-200
                                <?php elseif($latestProof->status === 'verified'): ?> bg-green-100 text-green-700 border border-green-200
                                <?php else: ?> bg-red-100 text-red-700 border border-red-200 <?php endif; ?>">
                                <?php echo e($latestProof->getStatusLabel()); ?>

                            </span>
                        </div>
                        <a href="<?php echo e($latestProof->getImageUrl()); ?>" target="_blank" class="block relative group">
                            <img src="<?php echo e($latestProof->getImageUrl()); ?>" alt="Bukti Pembayaran" class="w-full h-40 object-cover rounded-xl border border-gray-200">
                        ...
                        <p class="text-xs text-gray-500 mt-2 flex items-center gap-1">
                            ...
                            Diupload <?php echo e($latestProof->created_at->diffForHumans()); ?>

                        </p>
                        <?php if($latestProof->admin_notes): ?>
                            <div class="mt-3 p-3 bg-gray-50 rounded-lg text-xs text-gray-600">
                                <span class="font-semibold">Catatan Admin:</span> <?php echo e($latestProof->admin_notes); ?>

                            </div>
                        <?php endif; ?>
                    </div>
                <?php elseif($order->canUploadProof()): ?>
                    <a href="<?php echo e(route('user.payments.show-upload', $order)); ?>" class="btn-primary w-full mt-6 text-sm font-semibold h-11">
