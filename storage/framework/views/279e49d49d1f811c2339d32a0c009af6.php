...
<div class="max-w-7xl mx-auto space-y-6 pb-12 relative z-10">
    ...
    <div class="border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 overflow-x-auto scrollbar-hide">
            <li class="me-2">
                <a href="<?php echo e(route('user.orders.index', ['status' => 'semua'])); ?>" class="inline-flex items-center justify-center p-4 text-primary-600 border-b-2 border-primary-600 rounded-t-lg active bg-primary-50/50" aria-current="page">
                    Semua Pesanan
                </a>
            </li>
            <li class="me-2">
                <a href="<?php echo e(route('user.orders.index', ['status' => 'menunggu-pembayaran'])); ?>" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 transition-all">
                    Menunggu Pembayaran
                </a>
            </li>
            <li class="me-2">
                <a href="<?php echo e(route('user.orders.index', ['status' => 'diproses'])); ?>" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 transition-all">
                    Diproses
                </a>
            </li>
            <li class="me-2">
                <a href="<?php echo e(route('user.orders.index', ['status' => 'siap-diambil'])); ?>" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 transition-all">
                    Siap Diambil
                </a>
            </li>
            <li class="me-2">
                <a href="<?php echo e(route('user.orders.index', ['status' => 'selesai'])); ?>" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 transition-all">
                    Selesai
                </a>
            </li>
        </ul>
                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                    ...
                    <tr class="hover:bg-primary-50/10 transition-colors">
                        ...
                        <td class="px-6 py-5 align-top text-right">
                            ...
                            <a href="<?php echo e(route('user.payments.qr-code', $order)); ?>" class="btn-primary mt-3 text-xs py-2 px-3 inline-flex items-center gap-1 shadow-sm">
