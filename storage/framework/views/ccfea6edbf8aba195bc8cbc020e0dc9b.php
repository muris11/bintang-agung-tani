...
<div class="max-w-2xl mx-auto space-y-6 pb-12">
    ...
    <div class="card p-5 bg-gradient-to-br from-primary-50/30 to-white border-primary-200 animate-fade-in-up delay-100">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div>
                <h2 class="font-semibold text-gray-900"><?php echo e($order->paymentMethod->name); ?></h2>
                <p class="text-sm text-gray-600"><?php echo e($order->paymentMethod->bank_name); ?></p>
            </div>
        </div>
        <div class="bg-white rounded-lg p-4 border border-gray-200">
            <p class="text-sm text-gray-600 mb-1">Transfer ke:</p>
            <p class="font-mono text-lg font-bold text-gray-900 tracking-wider"><?php echo e($order->paymentMethod->account_number); ?></p>
            <p class="text-sm text-gray-600 mt-1">a.n. <?php echo e($order->paymentMethod->account_name); ?></p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="card p-6 animate-fade-in-up delay-150">
        ...
        <form action="<?php echo e(route('user.payments.upload-proof', $order)); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex flex-col sm:flex-row gap-3 pt-4">
                ...
                <a href="<?php echo e(route('user.payments.select-method', $order)); ?>" class="btn-secondary text-center">
                    Kembali
                </a>
            </div>
        </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bintang-agung-tani\resources\views/user/payments/upload-form.blade.php ENDPATH**/ ?>