    ...
    <div class="flex items-center gap-4 md:w-64 shrink-0">
        ...
        <a href="/admin/dashboard" class="flex items-center gap-2.5 group">
            ...
            <div class="hidden sm:block">
                <h1 class="text-white font-bold text-sm leading-tight group-hover:text-primary-100 transition-colors"><?php echo e($storeName); ?></h1>
    ...
    <div class="flex items-center gap-3 sm:gap-4 shrink-0">
        ...
        <div class="relative" x-data="{ open: false }" @click.away="open = false">
            <button @click="open = !open" class="flex items-center gap-2.5 focus:outline-none hover:bg-white/10 rounded-xl p-1.5 -ml-1.5 transition-colors">
                <img loading="lazy" src="https://ui-avatars.com/api/?name=<?php echo e($avatarName); ?>&background=ffffff&color=059669" alt="<?php echo e($authName); ?>" class="w-8 h-8 rounded-xl object-cover shadow-subtle ring-2 ring-white/30">
