    ...
    <div class="max-w-7xl mx-auto space-y-6 pb-12 px-4 sm:px-0 mt-4 md:mt-0 relative z-10 w-full">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center"><i class="ph ph-caret-right mx-1 text-gray-400 w-3 h-3"></i><a
                                    href="<?php echo e(route('user.profil.show')); ?>" class="hover:text-primary-600 transition-colors">Akun Saya</a></div>
                        </li>
                        <li>
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('user.dashboard')); ?>" class="btn-secondary text-sm h-10 shadow-sm border-gray-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10 mt-6">
            ...
            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', Setting::get('whatsapp_number', '082212345678'))); ?>" target="_blank"
            ...
            <div
                ...
                <div class="space-y-2 mt-4">
                    <div class="flex justify-between items-center text-sm border-b border-gray-100 pb-2">
                        ...
                        <span class="font-bold text-gray-900"><?php echo e(Setting::get('operational_hours', '08.00 - 17.00')); ?></span>
                    </div>
                    <div class="flex justify-between items-center text-sm border-b border-gray-100 pb-2">
                ...
                <div class="group">
                    ...
                    <div x-show="activeAccordion === 2" x-cloak x-collapse>
                        <div class="p-6 pt-0 text-sm text-gray-600 leading-relaxed border-t border-gray-50 bg-gray-50/10">
                            ...
                            tunjukkan QR tersebut kepada admin toko <?php echo e(Setting::get('store_name', 'Bintang Agung Tani')); ?> untuk di-_scan_ agar barang dapat
                            diserahkan.
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bintang-agung-tani\resources\views\user\bantuan.blade.php ENDPATH**/ ?>