                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select name="status" class="form-input w-full font-medium text-gray-900">
                                    ...
                                    <?php $__currentLoopData = ['menunggu_verifikasi' => 'Menunggu Verifikasi', 'processing' => 'Diproses', 'completed' => 'Selesai', 'cancelled' => 'Dibatalkan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
