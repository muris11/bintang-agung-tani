...
<div class="max-w-7xl mx-auto space-y-6 pb-12 relative z-10 w-full px-4 sm:px-0 mt-4 md:mt-0">
    ...
    <!-- Main Content -->
    <form action="/admin/users/<?php echo e($user->id); ?>" method="POST" class="max-w-2xl">
        <?php echo csrf_field(); ?>
        ...
        <div class="card p-6 space-y-6">
            ...
            <div class="flex items-center gap-4 pb-4 border-b border-gray-100">
                <img loading="lazy" src="https://ui-avatars.com/api/?name=<?php echo e($userAvatar); ?>&background=ecfdf5&color=059669&size=64" alt="<?php echo e($user->name); ?>" class="w-16 h-16 rounded-full ring-2 ring-primary-200">
                <div>
                    <h3 class="font-bold text-gray-900"><?php echo e($user->name); ?></h3>
                    <p class="text-sm text-gray-500">Bergabung: <?php echo e($user->created_at->locale('id')->isoFormat('D MMMM YYYY')); ?></p>
                </div>
            </div>
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" id="name" name="name" value="<?php echo e(old('name', $user->name)); ?>" class="form-input w-full" placeholder="Masukkan nama lengkap" required>
                </div>

                <div>
                    <label for="email" class="form-label mb-1.5 block">Alamat Email <span class="text-red-500">*</span></label>
                    <input type="email" id="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" class="form-input w-full" placeholder="nama@email.com" required>
                </div>

                <div>
                    <label for="phone" class="form-label mb-1.5 block">No. Telepon <span class="text-gray-400 font-normal ml-1">(Opsional)</span></label>
                    <input type="tel" id="phone" name="phone" value="<?php echo e(old('phone', $user->phone)); ?>" class="form-input w-full" placeholder="08xxxxxxxxxx">
                </div>
                ...
                <div>
                    ...
                    <textarea id="address" name="address" rows="3" class="form-input w-full resize-y" placeholder="Masukkan alamat lengkap"><?php echo e(old('address', $user->address)); ?></textarea>
                </div>
                ...
                <div class="border-t border-gray-100 pt-5">
                    <h3 class="font-bold text-gray-900 mb-4 flex items-center gap-2">
                        ...
                        Password Baru
                        <span class="text-xs font-normal text-gray-500 ml-1">(Kosongkan jika tidak ingin mengubah)</span>
                    </h3>

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            <label for="password" class="form-label mb-1.5 block">Password Baru</label>
                            <input type="password" id="password" name="password" class="form-input w-full" placeholder="••••••••">
                            <p class="text-xs text-gray-500 mt-1">Minimal 6 karakter</p>
                        </div>

                        <div>
                            <label for="password_confirmation" class="form-label mb-1.5 block">Konfirmasi Password Baru</label>
                            <input type="password" id="password_confirmation" name="password_confirmation" class="form-input w-full" placeholder="••••••••">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bintang-agung-tani\resources\views/admin/edit-user.blade.php ENDPATH**/ ?>