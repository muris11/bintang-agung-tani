...
<div class="max-w-7xl mx-auto space-y-6 pb-12 relative z-10 w-full px-4 sm:px-0 mt-4 md:mt-0">
    ...
    <div class="card overflow-hidden">
        ...
        <form action="<?php echo e(route('admin.kategori.store')); ?>" method="POST" class="p-6 space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div x-data="{ open: false, selected: '<?php echo e(old('icon', 'ph-tag')); ?>', search: '' }" 
...
<div x-show="open" x-cloak
                ...
                <input type="hidden" name="icon" x-model="selected" value="<?php echo e(old('icon', 'ph-tag')); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bintang-agung-tani\resources\views/admin/tambah-kategori.blade.php ENDPATH**/ ?>