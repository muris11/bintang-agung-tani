    ...
    <div class="p-4 md:p-6 max-w-3xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Pesan dari <?php echo e($message->name); ?></p>
            </div>
        </div>
            ...
            <div class="p-6">
                ...
                <div class="flex items-start gap-4 pb-6 border-b border-gray-100">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-lg font-bold text-gray-900"><?php echo e($message->name); ?></p>
                        <p class="text-sm text-gray-500"><?php echo e($message->email); ?></p>
                        <p class="text-xs text-gray-400 mt-1">Dikirim <?php echo e($message->created_at->format('d M Y, H:i')); ?></p>
                    </div>
                ...
                <!-- Message Content -->
                <div class="py-6">
                    <p class="text-sm font-medium text-gray-700 mb-3"><?php echo e($message->subject); ?></p>
                    <div class="prose prose-sm max-w-none text-gray-600 whitespace-pre-wrap"><?php echo e($message->message); ?></div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bintang-agung-tani\resources\views\admin\messages\show.blade.php ENDPATH**/ ?>