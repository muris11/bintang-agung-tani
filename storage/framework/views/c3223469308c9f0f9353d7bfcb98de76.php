    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2">
        <div>
            ...
            <div class="flex items-center gap-3">
                <h1 class="text-[28px] md:text-3xl font-bold text-gray-900 tracking-tight">Pesanan #<?php echo e($order->order_number); ?></h1>
                <span class="inline-flex px-2.5 py-1 text-xs font-bold rounded-full <?php echo e($order->getStatusBadgeClass()); ?> border mt-1.5 shadow-sm">
                    <?php echo e($order->getStatusLabel()); ?>

                </span>
            </div>
            <p class="text-sm border-gray-500 mt-1">Dibuat pada <?php echo e($order->created_at->format('d M Y, H:i')); ?> WIB</p>
        </div>
        <div class="flex items-center gap-3 hide-on-print">
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn-secondary text-sm h-10 shadow-sm border-gray-200">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div class="card p-0 overflow-hidden w-full printable-card shadow-sm border border-gray-200" id="invoiceArea">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start gap-6 relative z-10 w-full">
                        <div>
                            ...
                            <div class="inline-flex items-center gap-2 bg-white/20 px-3 py-1.5 rounded-lg border border-white/30">
                                ...
                                <span class="font-mono text-sm font-bold text-white tracking-wider"><?php echo e($order->order_number); ?></span>
                            </div>
                        </div>
                        <div class="text-left md:text-right">
                            <h3 class="font-bold text-lg text-white"><?php echo e(Setting::get('store_name', 'Bintang Agung Tani')); ?></h3>
                            <p class="text-sm text-primary-100 mt-1 leading-relaxed max-w-xs md:ml-auto">
                                <?php echo e(Setting::get('store_address_line1', 'Jl. Raya Pertanian No.12, Kec. Cisaat')); ?><br>
                                <?php echo e(Setting::get('store_address_line2', 'Kabupaten Sukabumi, Jawa Barat 43152')); ?>

                            </p>
                            <p class="text-sm font-medium text-primary-200 mt-2">
                                <i class="ph ph-phone inline w-4 h-4 mr-1"></i> <?php echo e(Setting::get('store_phone', '(0266) 123456')); ?>
                ...
                <div class="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-8 border-b border-gray-100 bg-white">
                    <div>
                        ...
                        <p class="font-bold text-gray-900 text-lg"><?php echo e($order->user->name ?? 'N/A'); ?></p>
                        <p class="text-sm text-gray-500 font-medium mt-0.5"><?php echo e($order->user->group_name ?? '-'); ?></p>
                        <div class="mt-3 space-y-1">
                            <p class="text-sm text-gray-600 flex items-start gap-2">
                                <i class="ph ph-map-pin w-4 h-4 text-gray-400 shrink-0 mt-0.5"></i>
                                <span><?php echo e($order->address->full_address ?? $order->shipping_address_snapshot ?? 'Alamat tidak tersedia'); ?></span>
                            </p>
                            <p class="text-sm text-gray-600 flex items-center gap-2">
                                <i class="ph ph-phone w-4 h-4 text-gray-400 shrink-0"></i>
                                <span><?php echo e($order->shipping_phone ?? $order->user->phone ?? '-'); ?></span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="md:text-right">
                        ...
                        <div class="space-y-2 inline-block text-left md:text-right">
                            <div class="flex justify-between md:justify-end gap-4">
                                ...
                                <span class="text-sm font-bold text-gray-900"><?php echo e($order->created_at->format('d M Y')); ?></span>
                            </div>
                            <div class="flex justify-between md:justify-end gap-4">
                                <span class="text-sm text-gray-500">Metode Pengiriman:</span>
                                <span class="text-sm font-bold text-gray-900"><?php echo e($order->shipping_courier ?? '-'); ?> <?php echo e($order->shipping_service ? '('.$order->shipping_service.')' : ''); ?></span>
                            </div>
                            <div class="flex justify-between md:justify-end gap-4 mt-2 pt-2 border-t border-gray-100">
                                ...
                                <span class="inline-flex px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded <?php echo e($order->getPaymentStatusClass()); ?>">
                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-100 text-sm">
                                ...
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-5 text-gray-500 text-center font-medium"><?php echo e($index + 1); ?></td>
                                    <td class="px-6 py-5">
                                        <p class="font-bold text-gray-900 text-base"><?php echo e($item->product_name); ?></p>
                                        <p class="text-xs text-gray-500 mt-1 font-medium">SKU: <?php echo e($item->product_sku ?? 'N/A'); ?></p>
                                    </td>
                                    <td class="px-6 py-5 text-right font-medium text-gray-600"><?php echo e($item->getFormattedUnitPrice()); ?></td>
                                    <td class="px-6 py-5 text-center font-bold text-gray-900"><?php echo e($item->quantity); ?></td>
                                    <td class="px-6 py-5 text-right font-bold text-gray-900"><?php echo e($item->getFormattedSubtotal()); ?></td>
                                </tr>
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-6">
                        <div class="w-full md:w-1/2">
                            ...
                            <p class="text-sm text-gray-600 bg-white p-4 rounded-xl border border-gray-100 italic shadow-sm">
                                <?php echo e($order->notes ?: 'Tidak ada catatan untuk pesanan ini.'); ?>
                        ...
                        <div class="w-full md:w-1/3 min-w-[250px] space-y-3">
                            <div class="flex justify-between items-center text-sm">
                                ...
                                <span class="font-bold text-gray-900"><?php echo e($order->getFormattedSubtotal()); ?></span>
                            </div>
                            <div class="flex justify-between items-center text-sm">
                                <span class="text-gray-500 font-medium">Ongkos Kirim (<?php echo e($order->shipping_courier ?? '-'); ?>)</span>
                                <span class="font-bold text-gray-900"><?php echo e($order->getFormattedShippingCost()); ?></span>
                            </div>
                            <?php if($order->discount_amount > 0): ?>
                            <div class="flex justify-between items-center text-sm">
                                <span class="text-gray-500 font-medium">Diskon</span>
                                <span class="font-bold text-green-600">-Rp <?php echo e(number_format($order->discount_amount, 0, ',', '.')); ?></span>
                            </div>
                            <?php endif; ?>
        ...
        <div class="lg:col-span-4 space-y-6 hide-on-print">
                    ...
                    <form action="<?php echo e(route('admin.orders.update-status', $order)); ?>" method="POST">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="tracking_number" value="<?php echo e($order->tracking_number); ?>" placeholder="Masukkan No. Resi (Cth: JNE12345...)" class="form-input w-full">
                            </div>
                            <div>
                                ...
                                <select name="status" class="form-input w-full font-medium text-gray-900">
                                    ...
                                    <?php $__currentLoopData = ['processing' => 'Diproses', 'shipped' => 'Dikirim', 'delivered' => 'Terkirim', 'completed' => 'Selesai', 'cancelled' => 'Dibatalkan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="p-6">
                    <div class="relative pl-6 border-l-2 border-gray-100 space-y-8 ml-2">
                        ...
                        <div class="relative">
                            ...
                            ?>
                            <div class="absolute w-4 h-4 rounded-full bg-<?php echo e($color); ?>-500 border-[3px] border-white -left-[33px] top-1 shadow-sm"></div>
                            <h3 class="font-bold text-gray-900 text-sm"><?php echo e($order::STATUS_LABELS[$history->status] ?? $history->status); ?></h3>
                            <?php if($history->changed_by): ?>
                            <p class="text-xs font-medium text-gray-500 mt-1 bg-gray-50 w-fit px-2 py-1 rounded">Oleh: <?php echo e($history->changed_by_user->name ?? 'Admin'); ?></p>
                            <?php else: ?>
                            <p class="text-xs font-medium text-gray-500 mt-1 bg-gray-50 w-fit px-2 py-1 rounded">Sistem Web E-Commerce</p>
                            <?php endif; ?>
                            <p class="text-[11px] text-gray-400 mt-1.5 flex items-center gap-1"><i class="ph ph-clock w-3 h-3"></i> <?php echo e($history->created_at->format('d M Y, H:i')); ?> WIB</p>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="relative">
                            ...
                            <p class="text-xs font-medium text-gray-500 mt-1 bg-gray-50 w-fit px-2 py-1 rounded">Sistem Web E-Commerce</p>
                            <p class="text-[11px] text-gray-400 mt-1.5 flex items-center gap-1"><i class="ph ph-clock w-3 h-3"></i> <?php echo e($order->created_at->format('d M Y, H:i')); ?> WIB</p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="card p-0 overflow-hidden mt-6">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <?php $__empty_1 = true; $__currentLoopData = $order->activityLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-start gap-3 pb-4 border-b border-gray-100 last:border-0 last:pb-0">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex items-center gap-2 mt-1">
                                    <span class="text-xs text-gray-500">Oleh: <?php echo e($log->user->name ?? 'System'); ?></span>
                                    <span class="text-gray-300">|</span>
                                    <span class="text-xs text-gray-500"><?php echo e($log->created_at->format('d M Y, H:i')); ?> WIB</span>
                                </div>
                                <?php if($log->metadata): ?>
                                <div class="mt-2 text-xs text-gray-600 bg-gray-50 p-2 rounded">
                                    <?php if(isset($log->metadata['notes'])): ?>
                                        <span class="font-medium">Catatan:</span> <?php echo e($log->metadata['notes']); ?>

                                    <?php elseif(isset($log->metadata['previous_status']) && isset($log->metadata['new_status'])): ?>
                                        <span class="font-medium">Perubahan:</span> <?php echo e($order::STATUS_LABELS[$log->metadata['previous_status']] ?? $log->metadata['previous_status']); ?> &rarr; <?php echo e($order::STATUS_LABELS[$log->metadata['new_status']] ?? $log->metadata['new_status']); ?>
            ...
            <div class="card p-0 overflow-hidden mt-6 border border-gray-100 shadow-sm">
                ...
                <div class="p-4 grid grid-cols-2 gap-3">
                    ...
                    <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $order->user->phone)); ?>" target="_blank" class="flex flex-col items-center justify-center p-3 rounded-xl border border-green-100 bg-green-50/50 hover:bg-green-100 transition-colors text-center group cursor-pointer">
                    ...
                    <a href="mailto:<?php echo e($order->user->email); ?>" class="flex flex-col items-center justify-center p-3 rounded-xl border border-blue-100 bg-blue-50/50 hover:bg-blue-100 transition-colors text-center group cursor-pointer">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bintang-agung-tani\resources\views/admin/detail-pesanan.blade.php ENDPATH**/ ?>