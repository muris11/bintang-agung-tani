    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div class="lg:col-span-4 space-y-4 sticky top-24">
            ...
            <div class="card p-2 bg-white flex items-center justify-center aspect-square overflow-hidden group">
                <img loading="lazy" src="<?php echo e($product->image_url ?? asset('images/no-product.jpg')); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover rounded-xl transition-transform duration-500 group-hover:scale-110">
            </div>
            ...
            <div class="grid grid-cols-4 gap-3">
                ...
                <button type="button" class="<?php echo e($index === 0 ? 'border-2 border-primary-500' : 'border-2 border-transparent hover:border-primary-300'); ?> rounded-lg overflow-hidden cursor-pointer shadow-sm relative transition-colors">
