...
<div class="max-w-7xl mx-auto space-y-6 pb-12 relative z-10 w-full px-4 sm:px-0 mt-4 md:mt-0">
    ...
    <!-- Main Content Grid -->
    <form id="create-product-form" action="<?php echo e(route('admin.produk.store')); ?>" method="POST" class="grid grid-cols-1 xl:grid-cols-3 gap-6" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="card p-6">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" id="name" name="name" class="form-input w-full" value="<?php echo e(old('name')); ?>" placeholder="Misal: Pupuk NPK Phonska 15-15-15" required>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <select id="category_id" name="category_id" class="form-input w-full bg-gray-50/50" required>
                                <option value="" disabled <?php echo e(old('category_id') ? '' : 'selected'); ?>>Pilih Kategori</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="brand" name="brand" class="form-input w-full" value="<?php echo e(old('brand')); ?>" placeholder="Misal: Petrokimia Gresik">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="6" class="form-input w-full rounded-t-none resize-y" placeholder="Tuliskan keterangan lengkap produk, manfaat, dan cara penggunaan..." required><?php echo e(old('description')); ?></textarea>
                    ...
                    <div class="md:col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="price_display"
                                ...
                                placeholder="0"
                                required>
                            <input type="hidden" id="price" name="price" value="<?php echo e(old('price')); ?>">
                        </div>
                    ...
                    <div class="md:col-span-1">
                        ...
                        <div class="flex">
                            ...
                            <select name="weight_unit"
                                ...
                                <option value="g" <?php echo e(old('weight_unit') == 'g' ? 'selected' : ''); ?>>Gram</option>
                                <option value="l" <?php echo e(old('weight_unit') == 'l' ? 'selected' : ''); ?>>Liter</option>
                                <option value="ml" <?php echo e(old('weight_unit') == 'ml' ? 'selected' : ''); ?>>Ml</option>
                            </select>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-1">
                        ...
                        <select id="unit" name="unit"
                            ...
                            required>
                            <option value="zak" <?php echo e(old('unit') == 'zak' ? 'selected' : ''); ?>>Zak / Karung</option>
                            <option value="botol" <?php echo e(old('unit') == 'botol' ? 'selected' : ''); ?>>Botol</option>
                            <option value="pcs" <?php echo e(old('unit') == 'pcs' ? 'selected' : ''); ?>>Pcs / Buah</option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="card p-6">
                ...
                <label class="inline-flex items-center cursor-pointer bg-gray-50 border border-gray-200 p-4 rounded-xl w-full">
                    ...
                    <input type="checkbox" name="is_active" value="1" class="sr-only peer" <?php echo e(old('is_active', '1') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bintang-agung-tani\resources\views\admin\tambah-produk.blade.php ENDPATH**/ ?>