...
<div class="max-w-7xl mx-auto space-y-6 pb-12 relative z-10">
    ...
    <div class="w-full h-48 sm:h-56 rounded-2xl overflow-hidden relative shadow-md border border-gray-200/50 mb-[-60px]">
        <img loading="lazy" src="<?php echo e(asset('images/banner-sawah.jpg')); ?>" alt="Banner Sawah" class="absolute inset-0 w-full h-full object-cover">
            ...
            <div class="lg:col-span-8 space-y-8">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-6 pb-6 border-b border-gray-100">
                    <div class="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full border-4 border-white shadow-lg overflow-hidden bg-white shrink-0 ring-2 ring-gray-100">
                        <img loading="lazy" src="https://ui-avatars.com/api/?name=<?php echo e($avatarName); ?>&color=047857&background=ecfdf5&bold=true&size=128" alt="<?php echo e($user->name); ?>" class="w-full h-full object-cover">
                    </div>
                ...
                <!-- Form Inputs -->
                <form action="<?php echo e(route('user.profil.update')); ?>" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-1.5 md:col-span-2 text-left">
                        ...
                        <input type="text" id="namaLengkap" name="name" value="<?php echo e($user->name); ?>" class="form-input w-full">
                    </div>

                    <div class="space-y-1.5 text-left">
                        <label for="email" class="form-label block text-left">Alamat Email</label>
                        <input type="email" id="email" name="email" value="<?php echo e($user->email); ?>" class="form-input w-full">
                    </div>

                    <div class="space-y-1.5 text-left">
                        <label for="telepon" class="form-label block text-left">No. Telepon / WhatsApp</label>
                        <input type="tel" id="telepon" name="phone" value="<?php echo e($user->phone ?? ''); ?>" class="form-input w-full">
                    </div>

                    <div class="space-y-1.5 md:col-span-2 text-left">
                        <label for="alamat" class="form-label block text-left">Alamat Lengkap Pengiriman</label>
                        <textarea id="alamat" name="address" rows="3" class="form-input w-full resize-y"><?php echo e($user->address ?? ''); ?></textarea>
                    </div>
                ...
                <div class="card overflow-hidden shadow-sm">
                    ...
                    <div class="p-5 space-y-4 text-sm">
                        <div class="flex items-start justify-between">
                            ...
                            <span class="font-bold text-gray-900 bg-gray-100 px-2 py-0.5 rounded"><?php echo e(auth()->user()->orders()->where('status', 'completed')->count()); ?> Transaksi</span>
                        </div>
                        <div class="flex items-start justify-between">
                            <span class="text-gray-500 font-medium">Total Belanja (Bulan ini)</span>
                            <span class="font-bold text-gray-900"><?php echo e(auth()->user()->getFormattedMonthlySpending()); ?></span>
                        </div>
                ...
                <div class="card p-5 shadow-sm bg-gradient-to-br from-white to-gray-50/50">
                    ...
                    <div class="space-y-3.5 text-sm text-gray-600">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <span class="leading-relaxed font-medium text-gray-800"><?php echo e($user->address ?? 'Alamat belum diisi'); ?></span>
                        </div>
                    </div>
                </div>
