...
<div class="max-w-7xl mx-auto space-y-6 pb-12 relative z-10 w-full px-4 sm:px-0 mt-4 md:mt-0">
        ...
        <div>
            <nav class="flex text-sm text-gray-500 mb-2" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li><div class="flex items-center"><i class="ph ph-caret-right mx-1 text-gray-400 w-3 h-3"></i></div></li>
                    <li class="text-gray-900 font-medium">Tambah Metode</li>
                </ol>
            </nav>
            <h1 class="text-[28px] md:text-3xl font-bold text-gray-900 tracking-tight">Tambah Metode Pembayaran</h1>
            <p class="text-sm text-gray-500 mt-1">Tambahkan metode pembayaran baru untuk transaksi pelanggan.</p>
        </div>
    ...
    <div class="card p-0 overflow-hidden border-primary-100">
        <div class="bg-gradient-to-r from-primary-50/40 to-primary-50/10 px-6 py-4 border-b border-primary-100 flex items-center gap-2">
            <i class="ph ph-plus-circle w-5 h-5 text-primary-600 ph-fill"></i>
            <h2 class="text-sm font-bold text-gray-900 uppercase tracking-wide">Form Metode Pembayaran</h2>
        </div>
        
        <form action="<?php echo e(route('admin.payment-methods.store')); ?>" method="POST" enctype="multipart/form-data" class="p-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                           value="<?php echo e(old('name')); ?>" required placeholder="Contoh: Transfer Bank BCA">
...
unset($__errorArgs, $__bag); ?>" 
                           value="<?php echo e(old('bank_name')); ?>" required placeholder="Contoh: BCA">
...
unset($__errorArgs, $__bag); ?> font-mono" 
                           value="<?php echo e(old('account_number')); ?>" required placeholder="1234567890">
...
unset($__errorArgs, $__bag); ?>" 
                           value="<?php echo e(old('account_name')); ?>" required placeholder="PT Bintang Agung">
...
unset($__errorArgs, $__bag); ?>" 
                           value="<?php echo e(old('sort_order', 0)); ?>" min="0" placeholder="0">
...
unset($__errorArgs, $__bag); ?>" 
                              placeholder="Masukkan instruksi pembayaran untuk pelanggan..."><?php echo e(old('instructions')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2 md:col-span-2">
                    <label class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="is_active" value="1" class="w-5 h-5 text-primary-600 rounded border-gray-300 focus:ring-primary-500" <?php echo e(old('is_active', true) ? 'checked' : ''); ?>>
                        <div>
                            <span class="font-semibold text-gray-900 block">Aktifkan Metode Pembayaran</span>
                            <span class="text-sm text-gray-500">Metode pembayaran akan langsung tersedia untuk pelanggan</span>
                        </div>
                    </label>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bintang-agung-tani\resources\views\admin\payment-methods\create.blade.php ENDPATH**/ ?>