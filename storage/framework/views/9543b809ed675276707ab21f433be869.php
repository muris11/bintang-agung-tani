...
<div class="max-w-7xl mx-auto space-y-6 pb-12 relative z-10 w-full px-4 sm:px-0 mt-4 md:mt-0">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2">
        ...
        <div class="flex items-center gap-3 shrink-0">
            <form action="<?php echo e(route('admin.settings.reset')); ?>" method="POST" class="inline">
                <?php echo csrf_field(); ?>
    ...
    <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" class="space-y-6" x-data="{ activeTab: 'store' }">
        <?php echo csrf_field(); ?>
            ...
            <div class="card p-6 border-primary-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="store_name" value="<?php echo e($storeSettings['store_name'] ?? 'Bintang Agung Tani'); ?>" 
                    ...
                    <div>
                        ...
                        <input type="text" name="store_branch" value="<?php echo e($storeSettings['store_branch'] ?? 'Cabang Agung Tani'); ?>" 
                            class="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="store_phone" value="<?php echo e($storeSettings['store_phone'] ?? '(0266) 123456'); ?>" 
                            class="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="store_address_line1" value="<?php echo e($storeSettings['store_address_line1'] ?? 'Jl. Raya Pertanian No.12, Kec. Cisaat'); ?>" 
                            class="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="store_address_line2" value="<?php echo e($storeSettings['store_address_line2'] ?? 'Kabupaten Sukabumi, Jawa Barat 43152'); ?>" 
                            class="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="store_address" rows="2" 
                            class="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 resize-none"><?php echo e($storeSettings['store_address'] ?? 'Jl. Pertanian No. 125, Jakarta Selatan, Indonesia'); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="card p-6 border-amber-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="operational_hours" value="<?php echo e($operationalSettings['operational_hours'] ?? '08.00 - 17.00'); ?>" 
                            class="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="operational_hours_full" value="<?php echo e($operationalSettings['operational_hours_full'] ?? '08.00 - 16.00 WIB'); ?>" 
                            class="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="whatsapp_number" value="<?php echo e($contactSettings['whatsapp_number'] ?? '0822-1234-5678'); ?>" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="contact_email" value="<?php echo e($contactSettings['contact_email'] ?? 'info@bintangtani.com'); ?>" 
                                class="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="support_email" value="<?php echo e($contactSettings['support_email'] ?? 'support@bintangagungtani.com'); ?>" 
                                class="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="social_facebook" value="<?php echo e($socialSettings['social_facebook'] ?? 'https://facebook.com/bintangagungtani'); ?>" 
                                class="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="social_instagram" value="<?php echo e($socialSettings['social_instagram'] ?? 'https://instagram.com/bintangagungtani'); ?>" 
                                class="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="social_twitter" value="<?php echo e($socialSettings['social_twitter'] ?? 'https://twitter.com/bintangtani'); ?>" 
                                class="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="social_youtube" value="<?php echo e($socialSettings['social_youtube'] ?? 'https://youtube.com/bintangagungtani'); ?>" 
                                class="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                        </div>
                    </div>
                </div>
        ...
        <div x-show="activeTab === 'ui'" x-cloak x-transition class="space-y-6" style="display: none;">
            ...
            <div class="card p-6 border-primary-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="show_welcome_banner" value="1" <?php echo e(($uiSettings['show_welcome_banner'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                    ...
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="show_categories_grid" value="1" <?php echo e(($uiSettings['show_categories_grid'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                    ...
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="show_stats_overview" value="1" <?php echo e(($uiSettings['show_stats_overview'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                    ...
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="show_best_sellers" value="1" <?php echo e(($uiSettings['show_best_sellers'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                    ...
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="show_new_arrivals" value="1" <?php echo e(($uiSettings['show_new_arrivals'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                    ...
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="show_promo_banners" value="1" <?php echo e(($uiSettings['show_promo_banners'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
            ...
            <div class="card p-6 border-amber-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="show_category_filter" value="1" <?php echo e(($uiSettings['show_category_filter'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                    ...
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="show_price_filter" value="1" <?php echo e(($uiSettings['show_price_filter'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                    ...
                    <div class="p-4 bg-gray-50 rounded-xl">
                        ...
                        <input type="number" name="products_per_page" value="<?php echo e($uiSettings['products_per_page'] ?? 20); ?>" min="8" max="100" class="w-full md:w-48 px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                    </div>
                    ...
                    <div class="p-4 bg-gray-50 rounded-xl">
                        ...
                        <input type="number" name="sidebar_category_count" value="<?php echo e($uiSettings['sidebar_category_count'] ?? 8); ?>" min="1" max="20" class="w-full md:w-48 px-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                    </div>
                </div>
            </div>
            ...
            <div class="card p-6 border-blue-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="enable_cart_drawer" value="1" <?php echo e(($uiSettings['enable_cart_drawer'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                    ...
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="enable_toast_notifications" value="1" <?php echo e(($uiSettings['enable_toast_notifications'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                    ...
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="enable_wishlist" value="1" <?php echo e(($uiSettings['enable_wishlist'] ?? false) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                    ...
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="show_search_bar" value="1" <?php echo e(($uiSettings['show_search_bar'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                    ...
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="show_cart_icon" value="1" <?php echo e(($uiSettings['show_cart_icon'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                    ...
                    <label class="flex items-start gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="show_user_menu" value="1" <?php echo e(($uiSettings['show_user_menu'] ?? true) ? 'checked' : ''); ?> class="w-5 h-5 mt-0.5 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
                        <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="total_farmers" value="<?php echo e($statisticsSettings['total_farmers'] ?? '10K+'); ?>" 
                                class="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="total_products" value="<?php echo e($statisticsSettings['total_products'] ?? '500+'); ?>" 
                                class="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="total_orders" value="<?php echo e($statisticsSettings['total_orders'] ?? '50K+'); ?>" 
                                class="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bintang-agung-tani\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>