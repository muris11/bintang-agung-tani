                ...
                <div class="flex items-center gap-4 pb-4 border-b border-gray-100">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Bergabung:
                            <?php echo e($user->created_at->locale('id')->isoFormat('D MMMM YYYY')); ?></p>
                    </div>
                </div>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="address" name="address" rows="3" class="form-input w-full resize-y"
                            placeholder="Opsional. Alamat utama user sebaiknya dikelola dari menu alamat user."><?php echo e(old('address', $user->address)); ?></textarea>
                        <?php if($user->defaultAddress): ?>
                            <p class="text-xs text-gray-500 mt-2">Alamat utama user saat ini:
                                <?php echo e($user->defaultAddress->getCompleteAddressAttribute()); ?></p>
                        <?php endif; ?>
                    </div>
