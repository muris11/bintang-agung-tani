<?php $__env->startSection('title', 'Kelola Metode Pembayaran'); ?>
...
<div class="container-main space-y-6 fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('admin.payment-methods.create')); ?>" class="btn-primary flex items-center gap-2 h-10 px-4 shadow-soft">
        ...
        <div class="card p-4 hover:-translate-y-1 transition-transform cursor-pointer border-b-4 border-b-emerald-500 bg-emerald-50/10">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-900"><?php echo e($paymentMethods->where('is_active', true)->count()); ?></h3>
                </div>
        ...
        <div class="card p-4 hover:-translate-y-1 transition-transform cursor-pointer border-b-4 border-b-red-500 bg-red-50/10">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-900"><?php echo e($paymentMethods->where('is_active', false)->count()); ?></h3>
                </div>
        ...
        <div class="card p-4 hover:-translate-y-1 transition-transform cursor-pointer border-b-4 border-b-blue-500 bg-blue-50/10">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-900"><?php echo e($paymentMethods->sum('orders_count')); ?></h3>
                </div>
        ...
        <div class="card p-4 hover:-translate-y-1 transition-transform cursor-pointer border-b-4 border-b-amber-500 bg-amber-50/10">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-900"><?php echo e($paymentMethods->count()); ?></h3>
                </div>
                    ...
                    <tr class="hover:bg-primary-50/30 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-bold text-gray-900"><?php echo e($method->name); ?></span>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-gray-700"><?php echo e($method->bank_name); ?></td>
                        <td class="px-6 py-4">
                            <span class="font-mono text-sm bg-gray-50 px-2 py-1 rounded border border-gray-200"><?php echo e($method->account_number); ?></span>
                        </td>
                        <td class="px-6 py-4 text-gray-700"><?php echo e($method->account_name); ?></td>
                        ...
                        <td class="px-6 py-4 text-center">
                            <span class="font-bold text-gray-900"><?php echo e($method->orders_count); ?></span>
                        </td>
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('admin.payment-methods.edit', $method)); ?>" class="text-blue-600 hover:text-blue-800 hover:bg-blue-50 px-2 py-1.5 rounded-lg transition-colors inline-flex items-center gap-1" aria-label="Edit <?php echo e($method->name); ?>">
                                ...
                                <form action="<?php echo e(route('admin.payment-methods.toggle', $method)); ?>" method="POST" class="inline">
                                    ...
                                    <button type="submit" class="text-amber-600 hover:text-amber-800 hover:bg-amber-50 px-2 py-1.5 rounded-lg transition-colors inline-flex items-center gap-1" aria-label="<?php echo e($method->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?> <?php echo e($method->name); ?>">
                                        <i class="ph ph-toggle-<?php echo e($method->is_active ? 'right' : 'left'); ?> w-4 h-4"></i>
                                        <span class="hidden sm:inline"><?php echo e($method->is_active ? 'Matikan' : 'Aktifkan'); ?></span>
                                    </button>
                                </form>
                                <form action="<?php echo e(route('admin.payment-methods.destroy', $method)); ?>" method="POST" class="inline" onsubmit="return confirmDelete(event, '<?php echo e($method->name); ?>')">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="text-red-600 hover:text-red-800 hover:bg-red-50 px-2 py-1.5 rounded-lg transition-colors inline-flex items-center gap-1" aria-label="Hapus <?php echo e($method->name); ?>">
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <a href="<?php echo e(route('admin.payment-methods.create')); ?>" class="btn-primary">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bintang-agung-tani\resources\views/admin/payment-methods/index.blade.php ENDPATH**/ ?>