...
class OrderController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $stats = [
            ...
            'shipped' => (int) $statsResult->shipped,
    ...
    public function updateStatus(Request $request, Order $order): RedirectResponse
    {
        ...
        try {
            ...
            // If status is shipped, also dispatch OrderShipped event
            if ($newStatus === Order::STATUS_SHIPPED) {
                event(new \App\Events\OrderShipped($order->fresh()));
            }
    ...
    public function bulkUpdateStatus(Request $request): RedirectResponse
    {
        $request->validate([
            ...
            'status' => 'required|string|in:pending,payment_pending,menunggu_verifikasi,processing,shipped,delivered,completed,cancelled,refunded',
        ], [
