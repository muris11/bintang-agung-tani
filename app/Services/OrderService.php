...
class OrderService
{
    ...
    public function getOrderStats(?int $userId = null): array
    {
        ...
        $processingOrders = (clone $query)->whereIn('status', [
    ...
    public function handleShipment(Order $order): void
    {
        // Placeholder for notification logic
        // TODO: Implement notification to user about shipment
    }

    public function handleCompletion(Order $order): void
    {
        // Placeholder for post-completion logic
        // TODO: Implement loyalty points, reviews, etc.
    }
    ...
    public function getValidStatusTransitions(string $currentStatus): array
    {
        return match ($currentStatus) {
            ...
            Order::STATUS_PAYMENT_PENDING => [
                ...
                Order::STATUS_PROCESSING, // Admin can directly confirm (bypass verification queue)
                Order::STATUS_CANCELLED,
            ],
            Order::STATUS_MENUNGGU_VERIFIKASI => [
                Order::STATUS_PROCESSING,
